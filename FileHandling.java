...
public class FileHandling {
	...
	public static void main(String[] args) {
		 Scanner strInput = new Scanner(System.in);
	        ...
	        while( cont.equalsIgnoreCase("y") ) {        	
		        ...
		        System.out.println("1 = Add New Emp Record ");
		        System.out.println("2 = View All Emp Record ");	
		        System.out.println("3 = Delete Emp Record ");
	  ...
	  public static void AddRecord() throws IOException {
  		...
  		System.out.print("Enter the Emp Address: ");
	...
	public static void SearchRecordbyID() throws IOException {
	    		...
	    		System.out.println("\t\t Search Emp Record\n");
	...
	public static void updateRecordbyID() throws IOException {
	    		...
	    		System.out.println("\t\t Update Emp Record\n\n");   
			/**/		
				System.out.println("Enter the Emp ID: ");
		    		ID = strInput.nextLine();	    		
		    		System.out.println(" ------------------------------------------------------------- ");
